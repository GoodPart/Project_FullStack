        ...
        const dialogMarkup = loading ? (
            ...
            <Grid container spacing={16} >
                <Grid item sm={5}>
                    ...
                    <img src={userImage ? userImage : "https://firebasestorage.googleapis.com/v0/b/socialape-32b84.appspot.com/o/no-img.png?alt=media" } alt="Profile" className={classes.profileImage} />
                </Grid>
                <Grid item sm={7}>
